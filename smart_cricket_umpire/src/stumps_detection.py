...
#         print("Invalid box provided:", box)
#         return None  # Or return the original box, depending on your needs
...
# def detect_and_update_stumps(new_box, current_stumps_bbox):
#     new_box = expand_stump_box(new_box)
#     new_area = (new_box[2] - new_box[0]) * (new_box[3] - new_box[1])
...
#             if new_box is None:  # Skip if the new box is invalid
#                 continue
